                      ...
                      <div className="flex justify-between items-start" onClick={() => setSelectedCar(car)}>
                        <div className="w-full">
                          <div className="flex items-start justify-between">
                            <h3 className="m-0 text-slate-900 font-bold text-[15px] tracking-tight flex items-center gap-1.5 flex-wrap leading-tight">
                              {car.make} {car.model}
                          ...
                          <div className="flex items-center gap-1.5 mt-1">
                            ...
                            {(() => {
                              ...
                              return <span className="text-[8px] bg-amber-50 text-amber-600 border border-amber-200 px-1 py-0.5 rounded font-bold uppercase tracking-wider shadow-sm">{docs.length}/{total} Docs</span>;
                            })()}
                            ...
                            {!car.isLegacy && daysInStock !== null && (
                              <div className={`flex items-center gap-0.5 text-[9px] font-bold uppercase tracking-wider px-1 py-0.5 rounded ${daysInStock > 60 ? 'bg-red-100 text-red-700' : daysInStock > 30 ? 'bg-amber-100 text-amber-700' : 'bg-emerald-100 text-emerald-700'
                                }`}>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50/80 border-b border-slate-200">
                      ...
                      <th className="py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider text-right">Document</th>
                        ...
                        >
                          <td className="py-4 px-6">
                            <div className="flex items-center gap-2 mb-1">
                              <h3 className="m-0 text-slate-900 font-bold text-base tracking-tight">
                                {car.make} {car.model}
                              </h3>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <span className="text-[11px] bg-white border border-slate-200 px-2 py-0.5 rounded font-bold text-slate-500 uppercase tracking-widest shadow-sm">
                          ...
                          <td className="py-4 px-6">
                            {!car.isLegacy && daysInStock !== null ? (
                              <div className={`inline-flex items-center gap-1.5 text-xs font-bold px-2 py-1 rounded-md ${daysInStock > 60 ? 'bg-red-50 text-red-600 border border-red-100' : daysInStock > 30 ? 'bg-amber-50 text-amber-600 border border-amber-100' : 'bg-emerald-50 text-emerald-600 border border-emerald-100'
                                }`}>
                          ...
                          <td className="py-4 px-6 text-right whitespace-nowrap">
                            {(() => {
                              ...
                              if (docs.length === total) {
                                return <span className="text-[10px] bg-emerald-50 text-emerald-600 border border-emerald-200 px-2 py-1 rounded font-bold shadow-sm">{total} / {total} Received</span>;
                              }
                              return <span className="text-[10px] bg-amber-50 text-amber-600 border border-amber-200 px-2 py-1 rounded font-bold shadow-sm">{docs.length} / {total} Received</span>;
                            })()}
                          </td>
